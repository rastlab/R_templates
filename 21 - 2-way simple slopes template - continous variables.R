...
pacman::p_load(parallel, tidyverse, haven, psych, pequod, QuantPsyc, lmSupport, apaTables)
...
save(dat, file = "./data/21_two_way_regression.RData")

# Load saved workspace: 
load("./data/21_two_way_regression.Rdata")
